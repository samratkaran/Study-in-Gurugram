...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative  border border-transparent dark:bg-black dark:border-white/[0.2] bg-blue-900 shadow-input flex justify-center space-x-4 px-8 py-6 text-white"
    >
      {children}
    </nav>
  );
